...
st.subheader(" :blue[Hello Welcome!]")
...
if selected == "Upload & Modify":
    image = st.file_uploader(label="Upload the image here", type=['png', 'jpg', 'jpeg'], label_visibility="hidden")
    ...
    if image is not None:
        ...
        with col2:
            selected = option_menu(
                ...
                default_index=0,
                orientation="horizontal",
                styles = '{"background-color": "#4682B4"}'
            )
